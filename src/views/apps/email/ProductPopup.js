...
import ProductLog from 'src/views/apps/email/ProductLog'
import ProductSidebar from 'src/views/apps/email/ProductSidebar'
import ProductCompose from 'src/views/apps/email/ProductCompose'
...
const ProductPopup = ({ folder, label }) => {
  // ** States
  ...
  const ProductComposeWidth = mdAbove ? 754 : smAbove ? 520 : '100%'
  ...
  return (
    ...
    >
      ...
      <ProductCompose
        ...
        ProductComposeWidth={ProductComposeWidth}
        toggleComposeOpen={toggleComposeOpen}
      />
    </Box>
  )
