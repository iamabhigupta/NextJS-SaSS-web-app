        ...
        return (
          <form key={0} onSubmit={handleAccountSubmit(onSubmit)}>
            <Grid container spacing={5}>
              ...
              <Grid item xs={12}>
                <FormControlLabel label='Physical Goods' control={<Checkbox name='Physical Goods' />} />
                <FormControlLabel label='Digital Goods' control={<Checkbox name='Digital Goods' />} />
                <FormControlLabel label='None' control={<Checkbox name='None' />} />
              </Grid>
